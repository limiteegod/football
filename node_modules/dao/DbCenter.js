...
DbCenter.prototype._initMain = function(cb)
{
    ...
    var jmatch = new Table(db, "jmatch", [
        ...
        new Column(db, "hostTeamId", "varchar", 80, false, undefined),
        new Column(db, "hostTeamName", "varchar", 80, false, undefined),
        new Column(db, "guestTeamId", "varchar", 80, false, undefined),
        new Column(db, "guestTeamName", "varchar", 80, false, undefined),
        new Column(db, "stageId", "varchar", 80, false, undefined),
        new Column(db, "groupId", "varchar", 80, false, undefined),
        new Column(db, "concede", "int", 11, false, 0), //让球
        new Column(db, "bigSep", "int", 11, false, 0),  //大小球分界线
        new Column(db, "status", "int", 11, false, 0),  //状态
        new Column(db, "hostHalfScore", "int", 11, false, 0),  //主队半场进球
        new Column(db, "guestHalfScore", "int", 11, false, 0),  //客队半场进球
        new Column(db, "hostEndScore", "int", 11, false, 0),  //主队全场进球
        new Column(db, "guestEndScore", "int", 11, false, 0),  //客队全场进球
        new Column(db, "matchTime", "date", -1, false, undefined),
        new Column(db, "version", "int", 11, false, 0)
    ]);
    db.put(jmatch);
