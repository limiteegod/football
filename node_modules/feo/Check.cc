...
void Check::Init()
{
    ...
    tpl->PrototypeTemplate()->Set(String::NewSymbol("getDrawNum"), FunctionTemplate::New(GetDrawNum)->GetFunction());
 ...
 * 获得开奖号码
 */
Handle<Value> Check::GetDrawNum(const Arguments& args)
{
    HandleScope scope;
    Handle<Array> array = Array::New();
    Check *obj = ObjectWrap::Unwrap<Check>(args.This());
    char *pTmp = obj->pDrawNum;
    array->Set(0, String::New(pTmp++, 1));
    array->Set(1, String::New(pTmp++, 1));
    array->Set(2, String::New(pTmp++, 1));
    array->Set(3, String::New(pTmp, 1));
