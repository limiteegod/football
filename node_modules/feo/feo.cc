 ...
 * Check的实例
 */
Handle<Value> GetIntSize(const Arguments& args)
{
    HandleScope scope;
    FeoNum *pFeoNum = new FeoNum(NULL, 0);
    int len = sizeof(pFeoNum);
    delete pFeoNum;
...
void init(Handle<Object> exports) {
    ...
    exports->Set(String::NewSymbol("getIntSize"), FunctionTemplate::New(GetIntSize)->GetFunction());
